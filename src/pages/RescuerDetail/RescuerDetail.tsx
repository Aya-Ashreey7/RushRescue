...
const RescuerDetail = () => {
  ...
  const [imageRejection, setImageRejection] = useState<{
    [key: string]: string;
  }>({});
  ...
  if (!rescuer) return <Loader />;

  const docFields = [
    {
      label: "Driving Licence (Front)",
      url: rescuer.driverLicenceFrontUrl,
      key: "driverLicenceFrontUrl",
    },
    {
      label: "Driving Licence (Back)",
      url: rescuer.driverLicenceBackUrl,
      key: "driverLicenceBackUrl",
    },
    {
      label: "Vehicle Licence (Front)",
      url: rescuer.vehicleLicenceFrontUrl,
      key: "vehicleLicenceFrontUrl",
    },
    {
      label: "Vehicle Licence (Back)",
      url: rescuer.vehicleLicenceBackUrl,
      key: "vehicleLicenceBackUrl",
    },
  ];
