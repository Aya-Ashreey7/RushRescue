            ...
            <Box sx={{ maxWidth: 1300, mx: "auto" }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 4 }}>
                    <Box>
                        ...
                        <Typography variant="h4" sx={{ fontWeight: 700, color: isDark ? '#fff' : '#1A1A2E' }}>Drivers</Typography>
                    </Box>
                ...
                <Paper sx={{ p: 4, mb: 4, bgcolor: isDark ? '#23243a' : '#fff', boxShadow: isDark ? 3 : 1, transition: 'background 0.3s' }}>
                    ...
                    <Stack direction="row" spacing={2} alignItems="center" justifyContent="space-between" sx={{ mb: 2 }}>
                       <Box sx={{ display: "flex", gap: 2 }}>  
                        <Button sx={{ backgroundColor: isDark ? '#22304a' : "#0F3460", color: "white", boxShadow: isDark ? 1 : 0 }}>All Drivers Requests</Button>
                        <Box sx={{
                            display: "flex",
                            alignItems: "center",
